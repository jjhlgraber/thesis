...
abstractor_kwargs = {
    ...
    "object_dim": 64,
    "symbol_dim": 12,  # Using a different symbol dimension
    "num_heads": 4,
    "ff_dim": 128,
    "dropout": 0.1,
    "MHA_kwargs": {
...
# cnn = torch.load("./cnn_checkpoints/cnn_custom_0123.pth")
...
if not debug:
    ...
    if save:
        torch.save(seq_model, "e2e_long_seq.pth")
